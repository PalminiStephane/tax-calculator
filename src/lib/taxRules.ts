...
export const ACTIVITY_LABELS: Record<ActivityType, string> = {
  ...
  BIC_SERVICES_COMMERCIAUX: 'BIC — Prestations de services commerciales',
  BIC_SERVICES_ARTISANAUX: 'BIC — Prestations de services artisanales',
...
export const ACTIVITY_DESCRIPTIONS: Record<ActivityType, string> = {
  ...
  BIC_SERVICES_COMMERCIAUX:
    'Agent commercial, courtier, intermédiaire de commerce, activités de services commerciales.',
...
export const ABATTEMENT_TAUX: Record<ActivityType, number> = {
  ...
  BIC_SERVICES_COMMERCIAUX: 0.50, // 50%
  BIC_SERVICES_ARTISANAUX: 0.50,  // 50%
  BNC_SSI: 0.34,               // 34%
  BNC_CIPAV: 0.34,             // 34%
}
...
export const TVA_SEUILS: Record<ActivityType, { base: number; majore: number }> = {
